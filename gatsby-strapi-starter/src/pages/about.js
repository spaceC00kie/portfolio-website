...
let About = () => (
  <PageTemplate title="About Me">
    <p>
      I'm a programmer. For real? Yeah. Who'd a thunk it?
    </p>
    <p>
      My journey began when I made a website to help me get a job in the customer service field.
      The experience was surprisingly fun and I noticed more people were contacting me for interviews.
    ...
    <p>
      This text is so interesting. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed commodo erat
      eu viverra mollis. Quisque tellus ante, commodo nec tellus sit amet,
      ornare blandit justo. Integer in cursus justo, vel aliquam ex. Etiam
      ligula sapien, sagittis eu posuere et, tincidunt a arcu. Nullam egestas
      lacus a molestie efficitur. Fusce neque mauris, commodo at lectus ut,
